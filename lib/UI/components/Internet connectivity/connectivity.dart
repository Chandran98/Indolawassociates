    ...
    Connectivity().onConnectivityChanged.listen((ConnectivityResult connectivityResult) {
     ...
     ConnectivityStatus _getstatus(ConnectivityResult connectivityResult){
       switch (connectivityResult) {
         case ConnectivityResult.mobile: return ConnectivityStatus.Mobile;
         
         case ConnectivityResult.wifi: return ConnectivityStatus.Wifi;
         case ConnectivityResult.none: return ConnectivityStatus.Offline; 
