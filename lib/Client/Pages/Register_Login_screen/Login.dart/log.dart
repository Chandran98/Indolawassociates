                              ...
                              child: Padding(
                                  ...
                                  child: !isLoading
                                      ? new TextButton(
                                          ...
                                          child: Container(decoration: BoxDecoration(borderRadius: BorderRadius.circular(20),color: gold,),
                                              
                                              height: MediaQuery.of(context) .size.height *0.07.h,width: MediaQuery.of(context) .size.width *0.5.h,
                                              // padding: const EdgeInsets.symmetric(
                                              //   vertical: 15.0,
                                              //   horizontal: 15.0,
                                              // ),
